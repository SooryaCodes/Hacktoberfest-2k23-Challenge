// Tool Cool Picker v1.0.9, MIT License - https://github.com/toolcool-org/toolcool-color-picker
(() => {
  var $t = Object.defineProperty;
  var Mt = (o, e, t) =>
    e in o
      ? $t(o, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (o[e] = t);
  var a = (o, e, t) => (Mt(o, typeof e != "symbol" ? e + "" : e, t), t);
  var tt =
    ":root{--tool-cool-color-picker-btn-bg:#fff;--tool-cool-color-picker-btn-border-color:#cecece;--tool-cool-color-picker-btn-border-color-inner:#626262;--tool-cool-color-picker-btn-border-radius:.25rem;--tool-cool-color-picker-btn-border-radius-inner:0}.color-picker{position:relative;width:40px;height:40px;}.button{width:100%;height:100%;padding:.7rem;background:var(--tool-cool-color-picker-btn-bg,#fff);border-radius:var(--tool-cool-color-picker-btn-border-radius,0.25rem);border-width:1px;border-style:solid;border-color:var(--tool-cool-color-picker-btn-border-color,#cecece);cursor:pointer;box-sizing:border-box}.button-color{width:100%;height:100%;display:block;background:#000;box-sizing:border-box;border-radius:var(--tool-cool-color-picker-btn-border-radius-inner,0)}";
  var et =
    ":root{--tool-cool-color-picker-popup-bg:#fff;--tool-cool-color-picker-popup-border-color:#cecece;--tool-cool-color-picker-popup-width:214px}.popup{position:absolute;left:-200px;top:calc(100% + 20px);z-index:50;width:var(--tool-cool-color-picker-popup-width,214px);box-shadow:0 8px 24px #010400;padding:.5rem;background:var(--tool-cool-color-picker-popup-bg,#fff);border-width:1px;border-style:solid;border-color:var(--tool-cool-color-picker-popup-border-color,#cecece);border-radius:.25rem; padding:.75rem}.popup.right{right:0;left:auto}";
  var ot =
  ...
  var p = "tc-hsv-changed",
    ...
    S = "tc-button-clicked",
    it = (o) => {
      !o || document.dispatchEvent(new CustomEvent(S, { detail: { cid: o } }));
    },
    y = (o, e) => {
      !o ||
    ...
    b = (o, e, t, i) => {
      !o ||
        document.dispatchEvent(
          new CustomEvent(p, { detail: { h: e, s: t, v: i, cid: o } })
        );
    },
    rt = (o, e) => {
      !o ||
        document.dispatchEvent(
          new CustomEvent(g, { detail: { h: e, cid: o } })
        );
    };
  function d(o, e) {
    Ht(o) && (o = "100%");
  ...
  function nt(o, e, t) {
    return { r: d(o, 255) * 255, g: d(e, 255) * 255, b: d(t, 255) * 255 };
  }
  function U(o, e, t) {
    (o = d(o, 255)), (e = d(e, 255)), (t = d(t, 255));
    ...
    if (i === r) (s = 0), (n = 0);
      ...
      var c = i - r;
      switch (((s = h > 0.5 ? c / (2 - i - r) : c / (i + r)), i)) {
        case o:
          n = (e - t) / c + (e < t ? 6 : 0);
          break;
        case e:
  ...
  function st(o, e, t) {
    var i, r, n;
    if (((o = d(o, 360)), (e = d(e, 100)), (t = d(t, 100)), e === 0))
      (r = t), (n = t), (i = t);
    else {
      var s = t < 0.5 ? t * (1 + e) : t + e - t * e,
        h = 2 * t - s;
      (i = O(h, s, o + 1 / 3)), (r = O(h, s, o)), (n = O(h, s, o - 1 / 3));
    }
  ...
  function at(o, e, t) {
    (o = d(o, 360) * 6), (e = d(e, 100)), (t = d(t, 100));
    var i = Math.floor(o),
      r = o - i,
      n = t * (1 - e),
      s = t * (1 - r * e),
      ...
      I = [h, t, t, s, n, n][c],
      yt = [n, n, h, t, t, s][c];
    return { r: P * 255, g: I * 255, b: yt * 255 };
  }
  function N(o, e, t, i) {
    var r = [
      x(Math.round(o).toString(16)),
    ...
    return (
      ...
      typeof o == "object" &&
        (E(o.r) && E(o.g) && E(o.b)
          ? ((e = nt(o.r, o.g, o.b)),
            (s = !0),
            (h = String(o.r).substr(-1) === "%" ? "prgb" : "rgb"))
          : E(o.h) && E(o.s) && E(o.v)
          ? ((i = M(o.s)),
            (r = M(o.v)),
            (e = at(o.h, i, r)),
  ...
  var l = (function () {
    function o(e, t) {
      ...
      typeof e == "number" && (e = lt(e)), (this.originalInput = e);
      var r = dt(e);
    ...
    return (
      ...
      (o.prototype.setAlpha = function (e) {
        return (
          (this.a = T(e)), (this.roundA = Math.round(100 * this.a) / 100), this
        );
      }),
      ...
      (o.prototype.toHex8 = function (e) {
        return e === void 0 && (e = !1), ht(this.r, this.g, this.b, this.a, e);
      }),
      ...
      (o.prototype.toName = function () {
        ...
        for (
          var e = "#" + N(this.r, this.g, this.b, !1),
            t = 0,
            i = Object.entries(k);
          t < i.length;
          t++
      ...
      (o.prototype.lighten = function (e) {
        e === void 0 && (e = 10);
        var t = this.toHsl();
        return (t.l += e / 100), (t.l = $(t.l)), new o(t);
      }),
      ...
      (o.prototype.desaturate = function (e) {
        e === void 0 && (e = 10);
        var t = this.toHsl();
        return (t.s -= e / 100), (t.s = $(t.s)), new o(t);
      }),
      ...
      (o.prototype.monochromatic = function (e) {
        e === void 0 && (e = 6);
        for (
          var t = this.toHsv(), i = t.h, r = t.s, n = t.v, s = [], h = 1 / e;
          e--;

        )
          s.push(new o({ h: i, s: r, v: n })), (n = (n + h) % 1);
        return s;
      }),
      ...
      (o.prototype.polyad = function (e) {
        for (
          var t = this.toHsl(), i = t.h, r = [this], n = 360 / e, s = 1;
          s < e;
          s++
        )
  ...
  var w = () => Math.random().toString(16).slice(2),
    R = (o) => Math.round((o + Number.EPSILON) * 100) / 100;
  var L = 0.01,
    F = (o) => (
      o < 0 && (o = 0), o > 360 && (o = 360), `hsl(${Math.round(o)}, 100%, 50%)`
    ),
    q = (o) => {
      let e = o.toRgb();
    ...
    A = (o) => {
      let e = o.toRgb();
      return `rgba(${e.r}, ${e.g}, ${e.b}, ${R(e.a)})`;
    },
    ut = (o) => {
      let e = o.toHsl();
      return `hsla(${Math.round(e.h)}, ${Math.round(e.s * 100)}%, ${Math.round(
        e.l * 100
      )}%, ${R(e.a)})`;
    },
    ct = (o) => {
      let e = o.toHsv();
      return `hsva(${Math.round(e.h)}, ${Math.round(e.s * 100)}%, ${Math.round(
        e.v * 100
      )}%, ${R(e.a)})`;
    },
    X = (o) => (
      o < 0 && (o = 0), o > 1 && (o = 1), `${(-(o * 100) + 100).toFixed(2)}%`
    ),
    j = (o) => (o < 0 && (o = 0), o > 1 && (o = 1), `${(o * 100).toFixed(2)}%`),
    H = (o) => {
      o < 0 && (o = 0), o > 360 && (o = 360);
      let e = (o * 100) / 360,
    ...
    _ = (o) => {
      let e = Number(o) || 0;
      return (
        (e = Math.round(e)), (e = Math.max(0, e)), (e = Math.min(255, e)), e
      );
    },
    pt = (o) => {
      let e = Number(o) || 100;
      return (
        (e = Math.round(e)), (e = Math.max(0, e)), (e = Math.min(100, e)), e
      );
    },
    u = (o) => {
      let e = new l(o || "#000");
  ...
  var W = class extends HTMLElement {
      ...
      render(t = !0) {
        this.$pointer &&
          ((this.$pointer.style.left = j(this.saturation)),
          (this.$pointer.style.top = X(this.value))),
          this.$color &&
            this.$color.setAttribute("style", `background: ${F(this.hue)}`),
      ...
      onChange(t) {
        ...
        if (i === 0 || r === 0) return;
        let h = typeof t.clientX == "number" ? t.clientX : t.touches[0].clientX,
          c = typeof t.clientY == "number" ? t.clientY : t.touches[0].clientY,
          P = Math.min(Math.max(0, h - n), i),
          I = Math.min(Math.max(0, c - s), r);
        (this.saturation = P / i), (this.value = 1 - I / r), this.render();
      }
      onPointerKeyDown(t) {
        switch (t.key) {
          case "ArrowLeft": {
            (this.saturation = Math.max(0, this.saturation - L)), this.render();
            break;
          }
          case "ArrowRight": {
            (this.saturation = Math.min(1, this.saturation + L)), this.render();
            break;
          }
          case "ArrowUp": {
            (this.value = Math.min(1, this.value + L)), this.render();
            break;
          }
          case "ArrowDown": {
            t.preventDefault(),
              (this.value = Math.max(0, this.value - L)),
              this.render();
            break;
          }
        }
      ...
      connectedCallback() {
        ...
        let i = u(this.getAttribute("color")).toHsv();
        ...
        (this.shadowRoot.innerHTML = `
           ...
           <div class="saturation">
                <div class="box" style="background: ${F(this.hue)}">
                    <div class="white box">
        ...
        `),
          ...
          document.addEventListener(g, this.hueChanged);
      }
      disconnectedCallback() {
        this.$saturation.removeEventListener("mousedown", this.onMouseDown),
          ...
          document.removeEventListener(g, this.hueChanged);
      }
  ...
  var z = class extends HTMLElement {
      ...
      render() {
        this.$pointer && (this.$pointer.style.left = `${H(this.hue)}%`),
          rt(this.cid, this.hue);
      }
      hsvChanged(t) {
        !t ||
          !t.detail ||
      ...
      onChange(t) {
        ...
        let n = typeof t.clientX == "number" ? t.clientX : t.touches[0].clientX,
          ...
          h = Math.min(Math.max(0, Math.round((s * 100) / i)), 100);
        (this.hue = D(h)), this.render();
      }
      onKeyDown(t) {
        switch ((this.$pointer.focus(), t.key)) {
          case "ArrowLeft": {
            let i = H(this.hue);
            (i = Math.max(0, i - 1)), (this.hue = D(i)), this.render();
            break;
          }
          case "ArrowRight": {
            let i = H(this.hue);
            (i = Math.min(100, i + 1)), (this.hue = D(i)), this.render();
            break;
          }
        }
      }
      ...
      connectedCallback() {
        this.cid = this.getAttribute("cid");
        let t = u(this.getAttribute("color"));
        (this.hue = t.toHsv().h),
          (this.shadowRoot.innerHTML = `
           <style>${gt}</style>
           <div class="hue">
                <div class="box">
                    ...
                    <div class="pointer box">
                        <div class="pointer-box" tabindex="0" style="left: ${H(
                          this.hue
                        )}%">
                            <div class="handler"></div>
                        </div>
  ...
  var Y = class extends HTMLElement {
      ...
      render(t = !0) {
        if (
          (this.$pointer && (this.$pointer.style.left = `${this.alpha * 100}%`),
          this.$color)
        ) {
          let i = new l({
            h: this.hue,
          ...
          this.$color.style.background = q(i);
        }
        t && y(this.cid, this.alpha);
      }
      onChange(t) {
        ...
        let n = typeof t.clientX == "number" ? t.clientX : t.touches[0].clientX,
          s = Math.min(Math.max(0, n - r), i),
          h = Math.min(Math.max(0, (s * 100) / i), 100);
        (this.alpha = h / 100), this.render();
      }
      onKeyDown(t) {
        switch ((this.$pointer.focus(), t.key)) {
          case "ArrowLeft": {
            let i = this.alpha * 100;
            (i = Math.max(0, i - 1)), (this.alpha = i / 100), this.render();
            break;
          }
          case "ArrowRight": {
            let i = this.alpha * 100;
            (i = Math.min(100, i + 1)), (this.alpha = i / 100), this.render();
            break;
          }
        }
      }
          ...
          (this.shadowRoot.innerHTML = `
           ...
           <div class="alpha">
                <div class="box">
                    ...
                    <div class="color-bg box" style="background: ${q(t)}"></div>
  ...
  var Q = class extends HTMLElement {
      ...
      hueChanged(t) {
        ...
        (this.color = new l({ h: Number(t.detail.h), s: i.s, v: i.v, a: i.a })),
          this.render();
      }
      alphaChanged(t) {
        if (!t || !t.detail || !t.detail.cid || t.detail.cid !== this.cid)
      ...
      render() {
        ...
        (this.r = t.r),
          ...
          this.$hex &&
            this.shadowRoot.activeElement !== this.$hex &&
            (this.$hex.value = this.hex.toUpperCase()),
          this.$r &&
            this.shadowRoot.activeElement !== this.$r &&
            (this.$r.value = this.r.toString()),
          this.$g &&
            this.shadowRoot.activeElement !== this.$g &&
            (this.$g.value = this.g.toString()),
          this.$b &&
            this.shadowRoot.activeElement !== this.$b &&
            (this.$b.value = this.b.toString()),
          this.$a &&
            this.shadowRoot.activeElement !== this.$a &&
      ...
      onAlphaChange(t) {
        let i = t.target,
          r = pt(i.value);
        r.toString() === i.value && y(this.cid, r / 100);
      }
      connectedCallback() {
        (this.cid = this.getAttribute("cid")),
          (this.color = u(this.getAttribute("color")));
        let t = this.color.toRgb();
        (this.r = t.r),
          (this.g = t.g),
          (this.b = t.b),
        ...
        (this.shadowRoot.innerHTML = `
           ...
           <div class="fields">
               ...
               <input id="a-${h}" type="text" value="${Math.round(
          this.a * 100
        )}" data-type="a" />
        ...
        `),
          ...
          (this.$a = this.shadowRoot.getElementById(`a-${h}`)),
          document.addEventListener(p, this.hsvChanged),
          document.addEventListener(g, this.hueChanged),
          document.addEventListener(m, this.alphaChanged),
  ...
  var J = class extends HTMLElement {
      constructor() {
        super();
        a(this, "cid");
        a(this, "popupPosition", "left");
        a(this, "$popup");
        a(this, "color", "#000");
        customElements.get("toolcool-color-picker-saturation") ||
          customElements.define("toolcool-color-picker-saturation", ft),
          customElements.get("toolcool-color-picker-hue") ||
            customElements.define("toolcool-color-picker-hue", bt),
          customElements.get("toolcool-color-picker-alpha") ||
            customElements.define("toolcool-color-picker-alpha", mt),
          customElements.get("toolcool-color-picker-fields") ||
            customElements.define("toolcool-color-picker-fields", xt),
          (this.cid = this.getAttribute("cid")),
      ...
      connectedCallback() {
        ...
        `),
          ...
          this.$popup.addEventListener("mousedown", this.prevent),
      ...
      attributeChangedCallback(t, i, r) {
        if (
          ...
          let n = this.shadowRoot.querySelector(
            ...
            s = this.shadowRoot.querySelector("toolcool-color-picker-hue"),
            h = this.shadowRoot.querySelector("toolcool-color-picker-alpha"),
            c = this.shadowRoot.querySelector("toolcool-color-picker-fields");
          n && n.setAttribute("color", this.color),
            s && s.setAttribute("color", this.color),
            h && h.setAttribute("color", this.color),
            c && c.setAttribute("color", this.color);
        }
      }
    },
    Ct = J;
  var Z = class extends HTMLElement {
      constructor() {
        ...
        (this.cid = w()),
          customElements.get("toolcool-color-picker-popup") ||
            customElements.define("toolcool-color-picker-popup", Ct),
          this.attachShadow({ mode: "open" }),
      ...
      get rgba() {
        return A(this.state.color);
      }
      get hsl() {
        return this.state.color.toHslString();
      }
      get hsla() {
        return ut(this.state.color);
      }
      get hsv() {
        return this.state.color.toHsvString();
      }
      get hsva() {
        return ct(this.state.color);
      }
      get opened() {
      ...
      onInitialColorChange() {
        let t = A(this.state.color);
        this.$buttonColor && (this.$buttonColor.style.backgroundColor = t);
        let i = this.shadowRoot.querySelector("toolcool-color-picker-popup");
        i && i.setAttribute("color", t);
      }
      onColorChange() {
        this.$buttonColor &&
          (this.$buttonColor.style.backgroundColor = A(this.state.color)),
          this.dispatchEvent(
      ...
      toggle() {
        ...
        window.setTimeout(() => {
          (this.state.isPopupVisible = !t), it(this.cid);
        }, 0);
      }
      onKeyDown(t) {
      ...
      connectedCallback() {
        (this.state.initialColor = u(this.getAttribute("color"))),
          (this.state.color = u(this.getAttribute("color"))),
          ...
          (this.shadowRoot.innerHTML = `
            ...
            <div class="color-picker">
                <button
                    ...
                    class="button"
                    title="Select Color">
                    <span class="button-color" style="background: ${A(
                      this.state.color
                    )}"></span>
                </button>
        ...
        `),
          ...
          document.addEventListener(g, this.hueChanged),
          document.addEventListener(m, this.alphaChanged),
          document.addEventListener(S, this.buttonClicked);
      }
      disconnectedCallback() {
        this.$button.removeEventListener("click", this.toggle),
          ...
          document.removeEventListener(g, this.hueChanged),
          document.removeEventListener(m, this.alphaChanged),
          document.removeEventListener(S, this.buttonClicked);
      }
  ...
  customElements.get("toolcool-color-picker") ||
    customElements.define("toolcool-color-picker", wt);
})();
